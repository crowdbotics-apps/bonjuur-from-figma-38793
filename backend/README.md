...
## Project Structure
    ...
    ├── bonjuur_from_figma_38793  # Django project configurations
...
1. Clone this repo and `cd bonjuur_from_figma_38793`
...
2. Clone this repo and `cd bonjuur_from_figma_38793`
